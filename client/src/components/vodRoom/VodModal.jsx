...
import { determinePlayPointOfBackupVod } from "../../utils/vimeo";
...
// const currentConference = {
//   action_url: "https://player.vimeo.com/video/531694718?autoplay=1@autopause=0",
//   idx: 2,
//   title_ko: "컨퍼런스 테스트 VOD",
// };
          ...
          <div className="pop-cell zoomIn">
            ...
            >
              ...
              <div className="pop-content pop-chat">
                <div className="modal-msg siemens">· 전체 화면 단축키 : F</div>
                    ...
                    <ul>
                      ...
                      >
                        ...
                        >
                          <iframe
                            // edit 1-1
                            // src={determinePlayPointOfBackupVod(
                            //   currentConference,
                            //   session.open_datetime
                            // )}
                            src={`${currentConference.vod_url}?autoplay=1&autopause=0`}
                            frameBorder="0"
